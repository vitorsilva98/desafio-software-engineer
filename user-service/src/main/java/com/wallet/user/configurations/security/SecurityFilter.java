package com.wallet.user.configurations.security;
...
import com.wallet.user.configurations.security.services.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (tokenJWT != null) {
            try {
                ...
                request.setAttribute("userId", tokenService.getUserIdClaim(tokenJWT));
                request.setAttribute("userEmail", tokenService.getSubject(tokenJWT));
            } catch (Exception e) {
