    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(authorizeHttpRequests -> {
                ...
                authorizeHttpRequests.requestMatchers(HttpMethod.POST, "/api/v1/wallet/auth/login").permitAll();
                authorizeHttpRequests.requestMatchers(HttpMethod.POST, "/api/v1/wallet/users").permitAll();
