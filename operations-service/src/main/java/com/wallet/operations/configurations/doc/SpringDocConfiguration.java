package com.wallet.operations.configurations.doc;
...
public class SpringDocConfiguration {
    ...
    private Info getApiInfo() {
        return new Info()
            .title("Wallet API - Operations Service")
            .description("Backend para aplicativo de carteira digital - Operations Service")
